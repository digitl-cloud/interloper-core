...
class CsvDestination(Destination):
    ...
    def __str__(self) -> str:
        ...
        return f"CsvDestination({self.base_path})"

    def _asset_path(self, context: DestinationContext) -> Path:
    ...
    def write(self, context: DestinationContext, data: list[dict[str, Any]]) -> None:
    ...
    def read(self, context: DestinationContext) -> list[dict[str, str]] | list[list[dict[str, str]]]:
